...
@app.route('/con/login', methods = ['GET'])
def get_login():
    return render_template('login.html')

@app.route('/con/login', methods = ['POST'])
def post_login():
...
@app.route('/con/logout', methods = ['GET'])
@login_required
def get_logout():
    logout_user()
    return render_template('index.html')
...
@app.route('/con/room/<int:num>', methods = ['GET'])
def get_room(num):
    room = Room.query.filter_by(room_id=num).first()
    return render_template('room_detail.html', room=room)

@app.route('/con/items/<int:num>', methods = ['GET'])
def get_items(num):
...
@app.route('/con/item/<int:num>', methods = ['GET'])
def get_item(num):
    item = Item.query.filter_by(item_id=num).first()
    return render_template('item_detail.html', item=item)

@app.route('/con/persons/<int:num>', methods = ['GET'])
def get_persons(num):
...
@app.route('/con/person/<int:num>', methods = ['GET'])
def get_person(num):
    person = Person.query.filter_by(person_id=num).first()
    return render_template('person_detail.html', person=person)

@app.route('/con/objectives/<int:num>', methods = ['GET'])
...
@app.route('/con/objective/<int:num>', methods = ['GET'])
...
@app.route('/con/junctions/<int:num>', methods = ['GET'])
...
@app.route('/con/junction/<int:num>', methods = ['GET'])
...
@app.route('/con/quest/<int:num>', methods=['POST'])
@login_required
def post_quest(num):
    objective = Objective.query.filter_by(objective_id=num).first()
...
@app.route('/con/quest/<int:num>', methods=['GET'])
@login_required
def get_quest(num):
    objective = Objective.query.filter_by(objective_id=num).first()
    room = Room.query.filter_by(room_id=objective.room_id).first()
...
@app.route('/con/solution/<int:num>', methods=['POST'])
@login_required
...
@app.route('/con/solution/<int:num>', methods=['GET'])
@login_required
...
@app.route('/con/mysolution/<int:num>', methods=['POST'])
@login_required
...
@app.route('/con/mysolution/<int:num>', methods=['GET'])
@login_required
...
@app.route('/con/mywalkthrough/<int:num>', methods=['GET'])
@login_required
